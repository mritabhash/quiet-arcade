...
export function SigilDial() {
  ...
  return (
    <div
      ...
      aria-hidden
      className={`pointer-events-none fixed z-30 h-28 w-28 opacity-80 sm:h-40 sm:w-40 md:h-48 md:w-48 ${
        cfg.side === "left" ? "-left-12 sm:-left-16 md:-left-20" : "-right-12 sm:-right-16 md:-right-20"
      }`}
